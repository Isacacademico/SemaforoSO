...
public class ThreadSemaforo extends Thread {
	 ...
	 * @param semaforoVermelho recebe o JLabel correspondente ao semáforo vermelho
	 *                         em questão
	 * @param semaforoVerde    recebe o JLabel correspondente ao semáforo verde em
	 *                         questão
	 ...
	 *                         aplicação
	 * @param op               recebe um valor inteiro que ajudará no
	...
	public ThreadSemaforo(JLabel carro, JLabel semaforoVermelho, JLabel semaforoVerde, Semaphore semaforo,
			JLabel fundoInicio, JButton btnInicio, int op) {
	...
	/**
	 * Método run da classe ThreadSemaforo que chama o método executa sem passagem
	 * de parâmetros
	 */
	...
	/**
	 * Método executa() que possui dentro de um try catch a utilização de semaforos
	 * a fim de definir um sincronismo nas Threads
	 */
	...
	/**
	 * Método acionaCarro() que é responsável por definir a movimentação do carro em
	 * questão
	 */
