...
public class ControleCarro implements ActionListener {
	...
	public ControleCarro(JLabel carro1, JLabel carro2, JLabel semaforoVermelho1, JLabel semaforoVermelho2,
			JLabel semaforoVerde1, JLabel semaforoVerde2, JLabel fundoInicio, JButton btnInicio) {
...
//		this.semaforoVerde4 = semaforoVerde4;
	...
	/**
	 * Método que é executado ao clicar sobre o JButton. Aqui será feita as chamadas
	 * à classe ThreadSemaforo com seus respectivos objetos
	 */
	...
	public void actionPerformed(ActionEvent e) {
		...
		ThreadSemaforo ts1 = new ThreadSemaforo(carro1, semaforoVermelho1, semaforoVerde1, semaforo, fundoInicio,
				btnInicio, 1);

		ThreadSemaforo ts2 = new ThreadSemaforo(carro2, semaforoVermelho2, semaforoVerde2, semaforo, fundoInicio,
				btnInicio, 2);
